...
{
    internal class OutputMatrix_L4491 : Matrix
    {
        public OutputMatrix_L4491(string inAddress)
            : base(inAddress)
        {
        }
        ...
        public void SW9(string value)
        {
            ...
            switch (value)
            {
                ...
                //case "position3": this.Send("ROUT:CLOS (@1104)"); break;
                //case "position4": this.Send("ROUT:CLOS (@1103)"); break;
