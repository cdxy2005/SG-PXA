...
namespace RackSys.TestLab.Instrument
{
    public abstract class SignalGenerator : ScpiInstrument
    {
        ...
        private double m_RFPowerLimitMax = 50;
        ...
        private  bool m_IsSafeCall = false;

        public virtual bool IsSafeCall
        {
            get { return m_IsSafeCall; }
            set { m_IsSafeCall = value; }
        }
        ...
        /// <summary>
        /// 幅度偏移量，按dB计。 注意：AV1464修改幅度Offset会同时仪表会自动修改输出功率以保持真实输出功率不变，故修改Offset后应伴随修改输出功率值，以达到期望输出功率。
        /// </summary>
        public virtual double AmplOffset
        {
            get
            {
                return -1*base.QueryNumber(":SOURce:pow:offset?");
 
            }
            set
            {
                base.SendNumber(":SOURce:pow:offset ", -1*value);
            }
        }
        ...
        /// 功率偏置状态
        /// </summary>
        public virtual bool AmplOffsetState
        {
            get
            {
                return base.Query(":POWer:OFFSet:STATe?") == "1";
            }
            set
            {
                base.Send(":POWer:OFFSet:STATe " + (value ? "ON" : "OFF"));
            }
        }     
        ...
        public virtual double PulsePeriod
        {
            get
            { return 0; }
            set
        ...
        /// 最小频率范围
        /// </summary>
        public virtual double RFFrequencyMin 
        {
            get 
            {
                return 250e3;
        ...
        /// 最大频率间隔
        /// </summary>
        public virtual double MaxFreqSpaceOfDoubleTone
        {
            get
            {
        ...
        /// 最小频率间隔
        /// </summary>
        public virtual double MinFreqSpaceOfDoubleTone
        {
            get
            {
                return 0;
        ...
        {
            if (model.IndexOf("N518") >= 0|| model.IndexOf("N517") >= 0)//识别所有N518X系列仪表为MXG   李佩操20150803日1545时
            { return true; }
            return (model == "N5182A") || (model == "N5182B");
        }
        ...
        public static bool IsEXG(string model)
        {
            if (model.IndexOf("N517") >= 0)
            { return true; }
            else
            { return false; }
        }
        ...
        {
            if (model.Contains( "AV1487"))
            {
                return true;
            }
            else if (model.Contains( "AV1463"))
            {
                  return true;
            }
            else
        ...
        /// <returns></returns>
        public virtual bool SignalGeratorConfigure(SignalGeneratorSetting SGsetting)
        {
            return false;
        }
        ...
        /// <param name="SGsetting"></param>
        /// <returns></returns>
        public virtual bool SignalGeratorConfigurationRead(out SignalGeneratorSetting SGsetting)
        {
