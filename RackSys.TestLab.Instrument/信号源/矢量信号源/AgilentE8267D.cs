...
namespace RackSys.TestLab.Instrument
{
    ...
    /// 矢量信号源设置参数
    /// </summary>
    public class VectorSignalGeneratorSetting
    {
        ...
        private bool m_NPREnable = false;

        public bool NPREnable
        {
            get { return m_NPREnable; }
            set { m_NPREnable = value; }
        }

        private bool m_TwoTonesEnable = false;

        public bool TwoTonesEnable
        {
            get { return m_TwoTonesEnable; }
            set { m_TwoTonesEnable = value; }
        }
        private double m_SignalBandWidth = 1e6;
        /// <summary>
        /// 宽带信号的信号带宽
        /// </summary>
        ...
        private uint m_SubCarrierNumber = 101;

        public uint SubCarrierNumber
        {
            get { return m_SubCarrierNumber; }
            set { m_SubCarrierNumber = value; }
        }


        private uint m_GapRatio = 1;
        /// <summary>
        /// NPR信号开口宽度百分比，1~100
        /// </summary>
        public uint GapRatio
        {
    ...
    public class AgilentE8267D : VectorSignalGenerator
    {
        ...
        public AgilentE8267D(string address)
            : base(address)
        {
        ...
        public override double MaxFreqSpaceOfDoubleTone
        {
            get 
            {
                return 80e6;
        ...
        public override double MinFreqSpaceOfDoubleTone 
        {
            get 
            {
                return 250000;
