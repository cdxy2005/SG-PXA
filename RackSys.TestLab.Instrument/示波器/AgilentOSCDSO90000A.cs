...
namespace RackSys.TestLab.Instrument
{
    ...
    /// 
    /// </summary>
    public class AgilentDSO90000A : OSCBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="inAddress">visa地址</param>
        public AgilentDSO90000A(string inAddress)
            : base(inAddress)
        {
        ...
        public override void SetInputImpedance(int Channel, double impedance)
        {
            if (impedance == 50)
                ...
                this.Send(string.Format(":CHANnel{0}:INPut DC", Channel));
        }
        /// <summary>
        /// 设置通道开启或关闭
        /// </summary>
        ...
        /// 单次扫描
        /// </summary>
        public override void Single(int time = 10000)
        {
            this.Send(":SINGle");
            WaitOpc(time);
        }
        ...
        //public override void SetTriggerPolarity(Polarity polarity_1)
        //{
        //    string str = "POS";
        //    switch (polarity_1)
        //    {
        ...
        //public override void SetTriggerSource(TriggerSource source_1)
        //{
        //    string str = "Channel1";
        //    str = source_1.ToString();
        //    switch (source_1)
